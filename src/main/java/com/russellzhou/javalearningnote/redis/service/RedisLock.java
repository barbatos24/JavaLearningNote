...
public class RedisLock {
    ...
    public boolean lock2(String key, String value) {
        ...
        if (!StringUtil.Object2String(current_value).equals("")
                //超时了
    ...
    public boolean lock3(String key, String value) {
        ...
        if (!StringUtil.Object2String(current_value).equals("")
            ...
            if (!StringUtil.Object2String(old_value).equals("")
    ...
    public void unlock(String key, String value) {
        try {
            if (StringUtil.Object2String(redisTemplate.opsForValue().get(key)).equals(value)) {
                redisTemplate.opsForValue().getOperations().delete(key);
                logger.info("成功释放redis分布式锁，key为{},value为{}",key,value);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
